...
public class AimbotCommands extends SubsystemBase {
    ...
    public SequentialCommandGroup depositReefBranch(Pose2d goToCoords, boolean isInAuton) {
        ...
        .andThen(this.wrist.goToElevatorPos(this.elevator.goingToHeight))
        .andThen(new WaitCommand(0.25))
        .andThen(this.drivetrain.fineTunePID(goToCoords, DrivetrainAligningTo.REEF, this.elevator.goingToHeight == elevatorLastSelectedHeight.FOUR ? RobotConstantsMeters.reefSafeDist + RobotConstantsMeters.reefDistCorrectionL4 : RobotConstantsMeters.reefSafeDist, true, AutoConstants.lidarFineTuneMaxTimeReef, AutoConstants.lidarDistanceToleranceReef))
        .andThen(this.elevator.goToPosition(this.elevator.goingToHeight))
